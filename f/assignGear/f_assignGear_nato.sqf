...
_baseUniform = [""];
_baseHelmet = ["MNP_Helmet_UN"];
_baseGlasses = [];

// Vests
_lightRig = ["V_BandollierB_cbr","V_BandollierB_khk"];
_mediumRig = ["V_BandollierB_cbr","V_BandollierB_cbr"]; 	// default for all infantry classes
_heavyRig = ["V_BandollierB_cbr"];
...
// CARGO: IFV - room for 10 weapons and 100 cargo items
	case "v_ifv":
	{
		...
		clearItemCargoGlobal _unit;
		clearBackpackCargoGlobal _unit;
		_unit addMagazineCargoGlobal [_MMGmag_tr, 6];
